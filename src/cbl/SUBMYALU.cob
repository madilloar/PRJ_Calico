...
006910    THEN
007190      MOVE VCODE-OPD(VCODE-PC)
007200                            TO WKC00LEFT-9
006880      DISPLAY 'JPZ OPD:('  WKC00LEFT-9 ')'
006880      DISPLAY 'JPZ PC :('  VCODE-PC ')'
006880*-    JPZのオペランドマイナス１しているのは、C80-の外側LOOPで、
006880*-    さらにカウントアップされるため。
006920      COMPUTE VCODE-PC = WKC00LEFT-9  - 1
006930   END-IF.
006940*-
...
006880   MOVE VCODE-OPD(VCODE-PC) TO WKB00J.
006880   COMPUTE WKB00J = WKB00J - 1.
006880   IF  WKB00J                < ZERO
006880    THEN
...
007380 C90-EXIT.
007390   EXIT.
006740 C0A-END SECTION.
006750*--------------------------------------------------------------
006760*- END
006770*--------------------------------------------------------------
006780 C0A-010.
006790   MOVE 'C0A-010.'          TO WK000SECTION.
006800*-
006890   DISPLAY 'END'.
